...
export default {
    ...
    computed:{
        tableData(){
            return null
            //return this.$store.getters['stats/getMonthStatsByDelivery']
        },
        tableRow(){
        ...
        deliveryOptions(){
            return this.$store.getters['orders/deliveryOptions']
        },
    },
    mounted(){
       //this.$store.dispatch('stats/fetchMonthStatsByDelivery',{month:this.month,year:this.year})
    }
}
</script>
