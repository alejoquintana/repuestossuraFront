...
export default {
    ...
    computed:{
        ...
        retiroStats(){
            return this.$store.getters['stats/getRetiroStats']
        },
        retiroMonth(){
            let res = [];
        ...
        dailyStats(){
            return this.$store.getters['stats/getstmonthats']
        },
        stats(){
        ...
        canceledStats(){
            return this.$store.getters['stats/getCanceledStats']
        },
        canceledMonth(){
    ...
    mounted(){
       this.$store.dispatch('stats/fetchCanceledStats')
       this.$store.dispatch('stats/fetchRetiroStats')
    }
}
</script>
