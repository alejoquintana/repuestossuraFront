<template>
    <div>
        ...
        <table class="table table-striped" v-if="tableData">
            <thead>
                <th>DIA</th>
                <th>PEDIDOS</th>
...
export default {
    ...
    computed:{
        tableData(){
            return this.$store.getters['stats/getMonthStats']
        },
        retiro_options(){
            return this.$store.getters['shop/getRetiroOptions']
        },
        isSuper(){
    ...
    methods:{
         async retiroChanged(){
            ...
            await this.$store.dispatch('stats/fetchMonthStats',{month:this.month,year:this.year})
            this.$store.commit('setLoading',false);
        }   
    },
    mounted(){
       this.$store.dispatch('stats/fetchMonthStats',{month:this.month,year:this.year})
